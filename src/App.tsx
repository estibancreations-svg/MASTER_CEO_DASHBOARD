...
function Workspace({name}:{name:string}){
  ...
  return <><div className="briefing workspace-hero"><div><span className="eyebrow">EXECUTIVE DECISION SURFACE</span><h2>{model.question}</h2><p>Read model refreshed just now · Governed actions are recorded in Audit & History.</p></div><button>Request THELMA briefing <ChevronRight/></button></div>
