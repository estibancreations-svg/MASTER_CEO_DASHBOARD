  ...
  return <div className="vw-studio-shell">
    ...
    <main className="vw-main">
      ...
      <section className={`vw-production-bar ${productionUser ? 'connected' : ''}`}>
        ...
        <div><b>{productionUser ? 'Production connected' : 'Connect Production to render real media'}</b><small>{productionUser ? productionUser.email : health ? 'All five media pipelines report ready. Sign-in protects provider credits and private outputs.' : 'Checking provider readiness…'}</small></div>
        {productionUser
