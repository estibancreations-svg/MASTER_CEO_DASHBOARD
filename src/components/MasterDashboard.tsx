...
export default function MasterDashboard({onOpenSuite,onOpenLandWeaver,onOpenVisionWeaver,onOpenGrantOS,onOpenThelma,onOpenCmgio}:{onOpenSuite:()=>void;onOpenLandWeaver:()=>void;onOpenVisionWeaver:()=>void;onOpenGrantOS:()=>void;onOpenThelma:()=>void;onOpenCmgio:()=>void}){
 ...
 return <div className="master-shell"><aside className={navOpen?'master-nav open':'master-nav'}>
  ...
  {active==='Dashboard'?<Dashboard systems={systems} onOpenSuite={onOpenSuite} onOpenLandWeaver={onOpenLandWeaver} onOpenVisionWeaver={onOpenVisionWeaver} onOpenGrantOS={onOpenGrantOS} onOpenThelma={onOpenThelma} onOpenCmgio={onOpenCmgio}/>:<ModulePage module={selected} data={command.moduleRecords.filter(r=>r.module_key===active)} onCreate={command.createModuleRecord}/>}</section>
 </main></div>
}

function Dashboard({systems,onOpenSuite,onOpenLandWeaver,onOpenVisionWeaver,onOpenGrantOS,onOpenThelma,onOpenCmgio}:{systems:any[];onOpenSuite:()=>void;onOpenLandWeaver:()=>void;onOpenVisionWeaver:()=>void;onOpenGrantOS:()=>void;onOpenThelma:()=>void;onOpenCmgio:()=>void}){
