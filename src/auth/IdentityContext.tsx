...
export type ExecutiveIdentity={session:Session|null;user:User|null;isBuilder:boolean;organizationId:string;organizationName:string;organizationSlug:string;role:'architect'|'ceo'|'delegated_approver'|'operator'|'auditor'|'viewer';scopes:string[];signOut:()=>Promise<void>};
